                ...
                <div class="app-container container-fluid d-flex align-items-stretch flex-stack mt-lg-8"
                    ...
                    <div class="d-flex align-items-center d-block d-lg-none ms-n3" title="Show sidebar menu">
                        ...
                        <a href="../../demo55/dist/index.html">
                            <img alt="Logo" src=" {{asset('metronic_demo55/demo55/dist/assets/media/logos/demo55-small.svg')}}"
                                class="h-25px theme-light-show" />
                            <img alt="Logo" src=" {{asset('metronic_demo55/demo55/dist/assets/media/logos/demo55-small-dark.svg')}}"
                                            ...
                                            <div class="scroll-y mh-200px mh-lg-350px">
                                                ...
                                                <a href="#"
                                                    ...
                                                    <div class="symbol symbol-40px me-4">
                                                        <img src=" {{asset('metronic_demo55/demo55/dist/assets/media/avatars/300-6.jpg')}}" alt="" />
                                                    </div>
                                                    <!--end::Symbol-->
                                                    <!--begin::Title-->
                                                ...
                                                <a href="#"
                                                    ...
                                                    <!--begin::Symbol-->
                                                    <div class="symbol symbol-40px me-4">
                                                        <img src=" {{asset('metronic_demo55/demo55/dist/assets/media/avatars/300-2.jpg')}}" alt="" />
                                                    </div>
                                                    <!--end::Symbol-->
                                                    <!--begin::Title-->
                                                    <div class="d-flex flex-column justify-content-start fw-semibold">
                                                ...
                                                <a href="#"
                                                    ...
                                                    <!--begin::Symbol-->
                                                    <div class="symbol symbol-40px me-4">
                                                        <img src=" {{asset('metronic_demo55/demo55/dist/assets/media/avatars/300-9.jpg')}}" alt="" />
                                                    </div>
                                                    <!--end::Symbol-->
                                                    <!--begin::Title-->
                                                    <div class="d-flex flex-column justify-content-start fw-semibold">
                                                ...
                                                <a href="#"
                                                    ...
                                                    <!--begin::Symbol-->
                                                    <div class="symbol symbol-40px me-4">
                                                        <img src=" {{asset('metronic_demo55/demo55/dist/assets/media/avatars/300-14.jpg')}}" alt="" />
                                                    </div>
                                                    <!--end::Symbol-->
                                                    <!--begin::Title-->
                                                    <div class="d-flex flex-column justify-content-start fw-semibold">
                                                ...
                                                <a href="#"
                                                    ...
                                                    <!--begin::Symbol-->
                                                    <div class="symbol symbol-40px me-4">
                                                        <img src=" {{asset('metronic_demo55/demo55/dist/assets/media/avatars/300-11.jpg')}}" alt="" />
                                                    </div>
                                                    <!--end::Symbol-->
                                                    <!--begin::Title-->
                                                    <div class="d-flex flex-column justify-content-start fw-semibold">
                                                    ...
                                                    <div class="symbol symbol-40px me-4">
                                                        <span class="symbol-label bg-light">
                                                            <img class="w-20px h-20px"
                                                                src=" {{asset('metronic_demo55/demo55/dist/assets/media/svg/brand-logos/volicity-9.svg')}}"
                                                                alt="" />
                                                        </span>
                                                    </div>
                                                    <!--end::Symbol-->
                                                ...
                                                <a href="#"
                                                    ...
                                                    <div class="symbol symbol-40px me-4">
                                                        <span class="symbol-label bg-light">
                                                            <img class="w-20px h-20px"
                                                                src=" {{asset('metronic_demo55/demo55/dist/assets/media/svg/brand-logos/tvit.svg')}}"
                                                                alt="" />
                                                        </span>
                                                    </div>
                                                    <!--end::Symbol-->
                                                ...
                                                <a href="#"
                                                    ...
                                                    <div class="symbol symbol-40px me-4">
                                                        <span class="symbol-label bg-light">
                                                            <img class="w-20px h-20px"
                                                                src=" {{asset('metronic_demo55/demo55/dist/assets/media/svg/misc/infography.svg')}}"
                                                                alt="" />
                                                        </span>
                                                    </div>
                                                    <!--end::Symbol-->
                                                ...
                                                <a href="#"
                                                    ...
                                                    <div class="symbol symbol-40px me-4">
                                                        <span class="symbol-label bg-light">
                                                            <img class="w-20px h-20px"
                                                                src=" {{asset('metronic_demo55/demo55/dist/assets/media/svg/brand-logos/leaf.svg')}}"
                                                                alt="" />
                                                        </span>
                                                    </div>
                                                    <!--end::Symbol-->
                                                ...
                                                <a href="#"
                                                    ...
                                                    <div class="symbol symbol-40px me-4">
                                                        <span class="symbol-label bg-light">
                                                            <img class="w-20px h-20px"
                                                                src=" {{asset('metronic_demo55/demo55/dist/assets/media/svg/brand-logos/tower.svg')}}"
                                                                alt="" />
                                                        </span>
                                                    </div>
                                                    <!--end::Symbol-->
                                            ...
                                            <div class="row g-2">
                                                ...
                                                <div class="col-4">
                                                    <a href="#"
                                                        ...
                                                        <img src=" {{asset('metronic_demo55/demo55/dist/assets/media/svg/brand-logos/amazon.svg')}}"
                                                ...
                                                <div class="col-4">
                                                    <a href="#"
                                                        class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                        <img src=" {{asset('metronic_demo55/demo55/dist/assets/media/svg/brand-logos/angular-icon-1.svg')}}"
                                                            class="w-25px h-25px mb-2" alt="" />
                                                ...
                                                <div class="col-4">
                                                    <a href="#"
                                                        class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                        <img src=" {{asset('metronic_demo55/demo55/dist/assets/media/svg/brand-logos/atica.svg')}}"
                                                            class="w-25px h-25px mb-2" alt="" />
                                                ...
                                                <div class="col-4">
                                                    <a href="#"
                                                        class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                        <img src=" {{asset('metronic_demo55/demo55/dist/assets/media/svg/brand-logos/beats-electronics.svg')}}"
                                                            class="w-25px h-25px mb-2" alt="" />
                                                ...
                                                <div class="col-4">
                                                    <a href="#"
                                                        class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                        <img src=" {{asset('metronic_demo55/demo55/dist/assets/media/svg/brand-logos/codeigniter.svg')}}"
                                                            class="w-25px h-25px mb-2" alt="" />
                                                ...
                                                <div class="col-4">
                                                    <a href="#"
                                                        class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                        <img src=" {{asset('metronic_demo55/demo55/dist/assets/media/svg/brand-logos/bootstrap-4.svg')}}"
                                                            class="w-25px h-25px mb-2" alt="" />
                                                ...
                                                <div class="col-4">
                                                    <a href="#"
                                                        class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                        <img src=" {{asset('metronic_demo55/demo55/dist/assets/media/svg/brand-logos/google-tag-manager.svg')}}"
                                                            class="w-25px h-25px mb-2" alt="" />
                                                ...
                                                <div class="col-4">
                                                    <a href="#"
                                                        class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                        <img src=" {{asset('metronic_demo55/demo55/dist/assets/media/svg/brand-logos/disqus.svg')}}"
                                                            class="w-25px h-25px mb-2" alt="" />
                                                ...
                                                <div class="col-4">
                                                    <a href="#"
                                                        class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                        <img src=" {{asset('metronic_demo55/demo55/dist/assets/media/svg/brand-logos/dribbble-icon-1.svg')}}"
                                                            class="w-25px h-25px mb-2" alt="" />
                                                ...
                                                <div class="col-4">
                                                    <a href="#"
                                                        class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                        <img src=" {{asset('metronic_demo55/demo55/dist/assets/media/svg/brand-logos/google-play-store.svg')}}"
                                                            class="w-25px h-25px mb-2" alt="" />
                                                ...
                                                <div class="col-4">
                                                    <a href="#"
                                                        class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                        <img src=" {{asset('metronic_demo55/demo55/dist/assets/media/svg/brand-logos/google-podcasts.svg')}}"
                                                            class="w-25px h-25px mb-2" alt="" />
                                                ...
                                                <div class="col-4">
                                                    <a href="#"
                                                        class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                        <img src=" {{asset('metronic_demo55/demo55/dist/assets/media/svg/brand-logos/figma-1.svg')}}"
                                                            class="w-25px h-25px mb-2" alt="" />
                                                ...
                                                <div class="col-4">
                                                    <a href="#"
                                                        class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                        <img src=" {{asset('metronic_demo55/demo55/dist/assets/media/svg/brand-logos/github.svg')}}"
                                                            class="w-25px h-25px mb-2" alt="" />
                                                ...
                                                <div class="col-4">
                                                    <a href="#"
                                                        class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                        <img src=" {{asset('metronic_demo55/demo55/dist/assets/media/svg/brand-logos/gitlab.svg')}}"
                                                            class="w-25px h-25px mb-2" alt="" />
                                                ...
                                                <div class="col-4">
                                                    <a href="#"
                                                        class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                        <img src=" {{asset('metronic_demo55/demo55/dist/assets/media/svg/brand-logos/instagram-2-1.svg')}}"
                                                            class="w-25px h-25px mb-2" alt="" />
                                                ...
                                                <div class="col-4">
                                                    <a href="#"
                                                        class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                        <img src=" {{asset('metronic_demo55/demo55/dist/assets/media/svg/brand-logos/pinterest-p.svg')}}"
                                                            class="w-25px h-25px mb-2" alt="" />
