            ...
            <div class="card-body d-flex flex-column flex-center">
                ...
                <div class="mb-2">
                    ...
                    <div class="py-10 text-center">
                        <img src=" {{asset('metronic_demo55/demo55/dist/assets/media/svg/illustrations/easy/2.svg')}}"
                            class="theme-light-show w-200px" alt="" />
                        <img src=" {{asset('metronic_demo55/demo55/dist/assets/media/svg/illustrations/easy/2-dark.svg')}}"
                ...
                <div class="text-center mb-1">
                    ...
                    <a class="btn btn-sm btn-primary me-2"
                        href="../../demo55/dist/apps/ecommerce/customers/listing.html">Try
                        now</a>
                    <!--end::Link-->
                    <!--begin::Link-->
                    <a class="btn btn-sm btn-light"
                        href="../../demo55/dist/apps/invoices/view/invoice-1.html">Learn
                        more</a>
                    <!--end::Link-->
                </div>
                <!--end::Links-->
    ...
    <div class="col-xl-4 mb-5 mb-xl-10">
        ...
        <div class="card card-flush h-md-100">
            ...
            <div class="card-header pt-7">
                ...
                <!--begin::Toolbar-->
                <div class="card-toolbar">
                    <a href="../../demo55/dist/apps/ecommerce/catalog/categories.html"
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <img src=" {{asset('metronic_demo55/demo55/dist/assets/media/stock/ecommerce/210.png')}}"
                                        class="w-50px" alt="" />
                                </td>
                                <td class="ps-0">
                            ...
                            <tr>
                                <td>
                                    <img src=" {{asset('metronic_demo55/demo55/dist/assets/media/stock/ecommerce/215.png')}}"
                                        class="w-50px" alt="" />
                                </td>
                                <td class="ps-0">
                                    <a href="../../demo55/dist/apps/ecommerce/sales/details.html"
                            ...
                            <tr>
                                <td>
                                    <img src=" {{asset('metronic_demo55/demo55/dist/assets/media/stock/ecommerce/209.png')}}"
                                        class="w-50px" alt="" />
                                </td>
                                <td class="ps-0">
                                    <a href="../../demo55/dist/apps/ecommerce/sales/details.html"
                            ...
                            <tr>
                                <td>
                                    <img src=" {{asset('metronic_demo55/demo55/dist/assets/media/stock/ecommerce/214.png')}}"
                                        class="w-50px" alt="" />
                                </td>
                                <td class="ps-0">
                                    <a href="../../demo55/dist/apps/ecommerce/sales/details.html"
